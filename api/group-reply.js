...
const FUNNEL_STAGE_HINT = {
  ...
  hot: 'Этап: ГОРЯЧИЙ. Человек готов. Покажи конкретный продукт с ценой, что входит и какой результат. Собери заявку и скажи, что команда ответит в этом же чате. Не задавай лишних вопросов.',
  warm: 'Этап: ТЁПЛЫЙ. Не дави и не прощайся. Дай ценность: похожий кейс из портфолио, разрушь страх, покажи результат. Затем мягко позови в канал и оставь дверь открытой.',
  cold: 'Этап: ХОЛОДНЫЙ. Не уговаривай купить. Дай бесплатную пользу: короткий разбор его ситуации и план из 2-3 шагов, которые он может сделать сам. Скажи, что это в подарок. Затем позови в канал.',
